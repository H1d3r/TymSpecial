...
Depending on which method of execution is chosen there are approximately 2-5 AV/EDR vendors detecting the payloads on [VirusTotal](https://virustotal.com) and 0 on [AntiScan.me](https://antiscan.me) when stageless Cobalt Strike shellcode is used with cloud fronting (As of 2/13/22). 
